...
public class Level2Activity extends Activity {
    ...
    private void newGame(int level) {
        ...
        switch (level) {
            case 3:
                intent = new Intent(Level2Activity.this, ResultActivity.class);
                break;
            case 4:
                intent = new Intent(Level2Activity.this, Result2Activity.class);
                break;
    ...
    public void onBackPressed(){
        ...
        builder.setMessage("Are you sure you want to exit?").setPositiveButton("Yes",new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                finish();
                Level2Activity.super.onBackPressed();
            }
        })
