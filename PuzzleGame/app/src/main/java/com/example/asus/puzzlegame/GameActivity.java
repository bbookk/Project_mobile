...
public class GameActivity extends Activity {
    ...
    private final int CADRS_ID[] = {R.drawable.zero, R.drawable.one, R.drawable.two, R.drawable.three,
            ...
            R.drawable.twelve, R.drawable.thirteen, R.drawable.fourteen, R.drawable.fifthteen};
    ...
    public void checkFinish() {
        if (cards.finished(N, N)) {
            ...
            final AlertDialog.Builder viewDialog = new AlertDialog.Builder(GameActivity.this);
            ...
            viewDialog.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    try {
                        String url = "http://horrorshortfilm.online/sorawit/saveAdData.php";
                        List<NameValuePair> params = new ArrayList<NameValuePair>();
                        params.add(new BasicNameValuePair("ad_player_name", input.getText().toString()));
                        params.add(new BasicNameValuePair("ad_move", numbSteps + ""));
                        params.add(new BasicNameValuePair("ad_finish_time", count + ""));
                        ...
                        if (strStatusID.equals("0")) {
                            Toast.makeText(GameActivity.this, strError, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(GameActivity.this, "Inserted", Toast.LENGTH_SHORT).show();
                        }
                    } finally { //close connection with DB
                    }
                    intent = new Intent(GameActivity.this, Result2Activity.class);
                    startActivity(intent);
                }
            });
            viewDialog.show();
